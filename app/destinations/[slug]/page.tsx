...
const staticDestinations: Record<string, any> = {
  ...
  'fort-st-jago': {
    ...
    description: 'Fort St. Jago is a historic fortification perched on a hill overlooking Elmina Castle and the Atlantic Ocean. Built by the Portuguese in the 16th century, this smaller but strategically important fort offers visitors breathtaking panoramic views of the coastline and a fascinating glimpse into the colonial history of Ghana.',
    history: 'Originally known as "St. Jago de Elmina" when built by the Portuguese in 1555, the fort was later captured by the Dutch in 1625. It served as a military outpost and trading post, primarily for gold and later for slaves. The fort was abandoned in 1832 but has since been restored and opened to visitors.',
    short_description: 'Historic hilltop fort with panoramic views of Elmina.',
    entry_fee: 35.00,
    opening_hours: '9:00 AM - 5:00 PM (Daily)',
    best_time_to_visit: 'November to March (dry season)',
    currency: 'GHS',
    highlights: ['Panoramic views of Elmina', 'Historical architecture', 'Military history', 'Photography opportunities', 'Sunset views'],
    gallery: [
